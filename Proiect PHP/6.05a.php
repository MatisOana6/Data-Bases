...
<br>
<div class="h2">
<h2 style="font-size:20px;">Contractele de muncă cu același comision:</h2>
</div>

<?php
$nr_comision=$_POST["nr_comision"];
$nr_comision=trim($nr_comision);
...
WHERE EXISTS (SELECT comision 
              ...
              WHERE contractm1.comision=contractm2.comision AND contractm1.id_cm!=contractm2.id_cm and comision = '$nr_comision')
ORDER BY comision;";
